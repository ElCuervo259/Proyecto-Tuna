            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-logo-nav class="block h-10 w-auto fill-current text-gray-600" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(Auth::user()->rol == 'Admin')
                    <x-nav-link :href="route('theatres.index')" :active="request()->routeIs('theatres.index')">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('users.config')">  
                           {{ __('Mi perfil') }}
                        </x-dropdown-link>
