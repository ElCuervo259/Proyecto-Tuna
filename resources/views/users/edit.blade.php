                ...
                <div class="p-6 bg-white border-b border-gray-200">    
                      ...
                      <form method="POST" action="{{ route('users.update',$user)}}" enctype="multipart/form-data">
                          ...
                          <div class="mt-4">
                             ...
                             <x-input id="name" type="text" name="name"  value="{{$user->name}}" class="w-full h-10 px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" required autofocus/>
                          </div> 
                          <!-- Mote -->
                          <div class="mt-4">
                            <x-label for="mote" :value="__('Mote')" />
                            <x-input id="mote" type="text" name="mote" value="{{$user->mote}}" class="w-full h-10 px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" required autofocus/>
                         </div>
                         <!-- rango -->
                          <div class="mt-4">
                            <x-label for="mote" :value="__('Rango')" />
                            <x-input id="rango" type="text" name="rango" value="{{$user->rango}}" class="w-full h-10 px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" required autofocus/>
                         </div>
                        ...
                        {{-- Select con los valores de group --}}
                         ...
                         <div class="mt-4">
                            ...
                            <x-input id="email" type="email" name="email" value="{{$user->email}}" class="w-full h-10 px-3 py-2 text-base text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline" required autofocus/>
                         </div>
