                   ...
                   <div class="container my-6 mx-auto px-4 md:px-12">
                     <div class="flex flex-wrap -mx-1 lg:-mx-2">  
                        ...
                        <div class="inline-block mr-2 mt-2">
                            ...
                            <button type="button" class="focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-blue-500 hover:bg-blue-600 hover:shadow-lg">Nuevo Premio</button>
                        </div></a>
                        @endif
                        ...
                        <div>
                            <div class="shadow overflow-hidden border border-gray-200 sm:rounded-lg m-6">
                                ...
                                <form method="GET" action="{{route('prize.filtro')}}">
                                    <div class="relative text-gray-600">
                                      ...
                                      <select  id="campo" name="campo" class="relative text-gray-600 rounded-full">
                                          <option value="name">Premio</option>
                                      </select>
                                    </label>
                                  </form>
                                </div>
                                              ...
                                              <td class="px-2 py-4 whitespace-nowrap text-sm text-gray-500">
                                                @if(Auth::user()->rol == 'Admin' )
                                                  <div class="flex justify-start space-x-1">
                                                      ...
                                                      <form method="POST" action="{{route('prizes.destroy', $prize)}}">
                                                        @csrf
                                                        @method('delete')
