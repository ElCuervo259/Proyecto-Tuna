                   ...
                   <div class="container my-6 mx-auto px-4 md:px-12">
                     <div class="flex flex-wrap -mx-1 lg:-mx-2">  
                        ...
                        <div class="inline-block mr-2 mt-2">
                            <a href="{{ route('theatres.create') }}">
                            <button type="button" class="focus:outline-none text-white text-sm py-2.5 px-5 rounded-md bg-blue-500 hover:bg-blue-600 hover:shadow-lg">Nuevo Teatro</button>
                        </div></a>
                        @endif
                        ...
                        <div>
                            <div class="shadow overflow-hidden border border-gray-200 sm:rounded-lg m-6">
                                ...
                                <form method="GET" action="{{route('theatre.filtro')}}">
                                          ...
                                          <tr>
                                              ...
                                              <td class="px-2 py-4 whitespace-nowrap">
                                               ...
                                               {{-- Para mostrar imagen si la hay --}}
                                                @isset($theatre->image_path)
                                                <img src="{{ asset('storage').'/'.$theatre->image_path }}" width="200"/>
                                                @endisset
